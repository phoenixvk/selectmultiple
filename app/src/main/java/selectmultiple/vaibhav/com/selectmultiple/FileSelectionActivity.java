...
public class FileSelectionActivity extends Activity {
    ...
    public void iconload(){
        ...
        {
            if (fileNames.get(i).contains(".pdf"))
            {
                pdfs.add(fileNames.get(i));
            }
        }
        filenames = pdfs.toArray(filenames);
        CustomList adapter2 = new CustomList(FileSelectionActivity.this, pdfs.toArray(filenames), mainPath.getPath());
